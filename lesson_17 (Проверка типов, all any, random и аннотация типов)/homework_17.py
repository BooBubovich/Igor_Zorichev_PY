...
"""
# items = [5, "hello", [1, 2], 3.14, {"a": 1}, "world"]
# lst = [i for i in items if isinstance(i, (str, list))]
#
# print(lst)
"""
===============================================
...
#     data_2 = (filter(f, data))
#     return list(data_2)
#
# print(filter_list(f_1, data_1))
"""
===============================================
...
"""
# def analyze(data: list[int]) -> tuple[int|float]:
#     if any(data):
...
#
# random.seed(228)
# res = ' '.join(list(str(random.randint(0, 100)) for _ in range(10)))
#
# print(res)
# print(res)
# print(res)
...
# print(greet(input('Как тебя звать? ')))
"""
===============================================
